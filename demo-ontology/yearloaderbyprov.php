...
include_once ('query.php');
                ...
                //FILTER (x? >='.$year.'
                $query='select distinct ?x where{?y rdf:type DemoOntology:Province. ?y DemoOntology:hasName "'.$mun.'"^^rdfs:Literal. ?y DemoOntology:hasPopulation ?pop. ?pop DemoOntology:livingInTheYear ?x.}ORDER by ?x';
                $query=openRDF($query);
